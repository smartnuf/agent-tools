...
This first alpha prerelease makes the `agent-tools` diagnostic command available as a versioned wheel without cloning the repository. It also includes the source distribution and a `SHA256SUMS` manifest.
