...
| Install, pin, and uninstall documentation is verified | complete | README commands and three-platform published-release smoke jobs |

Estimate: **4–7 person-days**.

Complete on 2026-08-29. Actual engineering effort was not recorded. The immutable `v0.1.0` tag failed workflow validation before creating a release; the incident and recovery are preserved in `docs/releases/v0.1.0.md`. Version `v0.1.1` supplied all required evidence.
