...
| Core installation no longer requires document libraries; a separately requested document install has a specified compatibility contract | in-progress | #57/#109; [runtime and installed shapes](04-document-implementation.md), #111 lifecycle pending |
