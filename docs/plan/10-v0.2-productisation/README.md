...
| CI evidence distinguishes seeded/simulated/native mutation paths and exercises primary real provider mutations through the installed CLI where practical | complete on #117 merge | #104/#115; [inspected mutation run and maintained matrix](../../platforms.md#observed-installed-cli-native-mutations) |
| Maintained platform evidence reports OS/distribution version, architecture, provider path, evidence class, and important common gaps without overclaiming | complete on #117 merge | #104/#115; [inspected mutation run and maintained matrix](../../platforms.md#observed-installed-cli-native-mutations) |
