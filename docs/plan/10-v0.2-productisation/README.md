...
the authorized [v0.2.1 correction](12-doc-patch-release.md). Keep
...
| README/PyPI front door describes the new core/doc/CLI contract and builds on merged PR #102 | in-progress | #122/#124; [published-text defect and disposition](11-release-qualification.md#published-text-defect-and-disposition) |
