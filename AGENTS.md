...
- Bound CI steps that invoke external installers with explicit timeouts. After inspecting a failure, retry the same head at most once; never push an empty or unrelated commit merely to retrigger CI.
